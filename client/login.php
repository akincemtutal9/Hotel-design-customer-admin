...
<h2>LOGIN</h2>
<img src="images/hotel_logo.png" alt="" style="vertical-align: middle;">
<?php
...
else if($username=="akincemtutal" and $password == "12"){
    header("Location:/client/adminStatus.html?username=$username");
    die();
}
else{
    echo "WRONG!";
